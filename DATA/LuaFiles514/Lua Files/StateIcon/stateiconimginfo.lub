...
StateIconImgList = {
	[PRIORITY_GOLD] = {
		...
		[EFST_IDs.EFST_JP_EVENT01] = "i_bunsin.tga",
		[EFST_IDs.EFST_JP_EVENT02] = "efst_matk.tga",
		[EFST_IDs.EFST_JP_EVENT03] = "efst_matk.tga",
		[EFST_IDs.EFST_JP_EVENT04] = "efst_atk.tga",
		[EFST_IDs.EFST_PAD_READER_KNIGHT] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_CRUSADER] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_BLACKSMITH] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_ALCHEMIST] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_ASSASSIN] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_ROGUE] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_WIZARD] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_SAGE] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_PRIEST] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_MONK] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_HUNTER] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_BARD] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_DANCER] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_TAEKWON] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_NINJA] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_GUNSLINGER] = "gogi.tga",
		[EFST_IDs.EFST_PAD_READER_SUPERNOVICE] = "gogi.tga"
	},
	[PRIORITY_RED] = {
		...
		[EFST_IDs.EFST_BODYSTATE_UNDEAD] = "BD_Undead.tga",
		...
		[EFST_IDs.EFST_HEALTHSTATE_BLIND] = "HL_Blind.tga",
		[EFST_IDs.EFST_HEALTHSTATE_ANGELUS] = "HL_ANGELUS.tga",
		[EFST_IDs.EFST_HEALTHSTATE_BLOODING] = "HL_Blooding.tga",
		...
		[EFST_IDs.EFST_PROPERTYUNDEAD] = "BD_Undead.tga"
	},
	[PRIORITY_BLUE] = {
		...
		[EFST_IDs.EFST_PACKING_ENVELOPE1] = "물리방어포션.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE2] = "물리방어포션.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE3] = "물리방어포션.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE4] = "물리방어포션.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE5] = "물리방어포션.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE6] = "물리방어포션.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE7] = "물리방어포션.tga",
		[EFST_IDs.EFST_PACKING_ENVELOPE8] = "물리방어포션.tga",
		...
		[EFST_IDs.EFST_ACUO_MINT_GUM] = "i_starcomfort.tga",
		[EFST_IDs.EFST_S_HEALPOTION] = "소형생명수.tga",
		[EFST_IDs.EFST_HANDICAPTOLERANCE_LEVELGAP] = "HANDICAPTOLERANCE_LEVELGAP.tga",
		[EFST_IDs.EFST_MTF_MARIONETTE] = "ELDICASTES.tga",
		[EFST_IDs.EFST_MTF_LUDE] = "ELDICASTES.tga",
		[EFST_IDs.EFST_MTF_CRUISER] = "ELDICASTES.tga",
		[EFST_IDs.EFST_HELM_VERKANA] = "물리방어포션.tga",
		[EFST_IDs.EFST_HELM_RHYDO] = "물리방어포션.tga",
		[EFST_IDs.EFST_HELM_TURISUS] = "물리방어포션.tga",
		[EFST_IDs.EFST_HELM_HAGALAS] = "물리방어포션.tga",
		[EFST_IDs.EFST_HELM_ISIA] = "물리방어포션.tga",
		[EFST_IDs.EFST_HELM_ASIR] = "물리방어포션.tga",
		[EFST_IDs.EFST_HELM_URJ] = "물리방어포션.tga"
	},
	[PRIORITY_GREEN] = {
