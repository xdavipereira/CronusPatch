SKILL_DESCRIPT = {
	...
	[SKID.HW_SOULDRAIN] = {
		...
		"depend on monster's level, skill level and",
		"caster's MaxSP.^000000",
	...
	[SKID.ECL_SNOWFLIP] = {
		"Snow Flip",
		"^777777눈송이처럼 하얗고 만지면 손이 시릴 듯한 꽃잎. 동상에 걸릴지도 모르니 주의.^000000",
		"^777777Recover from burning, bleeding, deep sleep and sleep.^000000"
	},
	[SKID.ECL_PEONYMAMY] = {
		"Peony Mommy",
		"^777777엄마 품처럼 따스한 온도를 가진 분홍색의 도톰한 꽃잎.^000000",
		"^777777Recover from Frozen, Freezing and Crystallization.^000000"
	},
	[SKID.ECL_SADAGUI] = {
		"Slapping Herb",
		"^777777냄새를 코로 들이마시면 머리를 때리는 듯한 강렬한 향을 가진 허브잎. 때때로 부작용도 있는 듯.^000000",
		"^777777Recover from stun, fear, confuse and Hallucination.^000000"
	},
	[SKID.ECL_SEQUOIADUST] = {
		"Yggdrasil Dust",
		"^777777생명의 나무의 잎에 붙어있던 먼지 부스러기지만 모아서 사용했을 때는 정화 능력을 발휘한다.^000000",
